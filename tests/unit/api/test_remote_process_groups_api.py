...
from pynifi_client.api.remote_process_groups_api import RemoteProcessGroupsApi  # noqa: E501
...
class TestRemoteProcessGroupsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pynifi_client.api.remote_process_groups_api.RemoteProcessGroupsApi()  # noqa: E501
